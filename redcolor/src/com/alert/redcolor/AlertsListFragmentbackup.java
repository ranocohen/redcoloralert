...
public class AlertsListFragmentbackup extends ListFragment implements
		OnScrollListener {
	...
	public static AlertsListFragmentbackup newInstance() {
		AlertsListFragmentbackup fragment = new AlertsListFragmentbackup();
